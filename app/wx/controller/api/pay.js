...
module.exports = class extends Base {
  ...
  prepayAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      const orderInfo = yield _this.model('wx_order').where({ id: orderId }).find();
      ...
      const openid = yield _this.model('wx_user').where({ id: orderInfo.user_id }).getField('weixin_openid', true);
  ...
  notifyAction() {
    ...
    return _asyncToGenerator(function* () {
      const WeixinSerivce = _this2.service('weixin', 'wx');
      ...
      const orderModel = _this2.model('wx_order');
