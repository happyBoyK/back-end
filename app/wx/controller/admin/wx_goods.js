...
module.exports = class extends Base {
  ...
  allDataAction() {
    ...
    return _asyncToGenerator(function* () {
      let data = yield _this2.model('wx_goods').allData();
  ...
  pageDataAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      let data = yield _this3.model('wx_goods').pageData(param);
  ...
  addDataAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this4.model('wx_goods').addData(param);
  ...
  updateDataAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this5.model('wx_goods').updateData(param);
  ...
  delDataAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this6.model('wx_goods').delData(param);
  ...
  delFlagDataAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this7.model('wx_goods').delFlagData(param);
  ...
  changeStatusAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this8.model("wx_goods").changeStatus(param);
