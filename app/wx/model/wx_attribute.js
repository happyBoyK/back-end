...
module.exports = class extends think.Model {
  ...
  pageData(param) {
    ...
    return _asyncToGenerator(function* () {
      let sql = _this5.page(param.current).where({ del_flag: 0, attribute_category_id: param.pid }).order('sort_order');
  ...
  findListByPid(param) {
    ...
    return _asyncToGenerator(function* () {
      let data = yield _this6.where({ del_flag: 0, attribute_category_id: param.pid }).select();
      return data;
    })();
  }
  ...
  allData(param) {
    ...
    return _asyncToGenerator(function* () {
      let data = yield _this7.where({ del_flag: 0 }).select();
      return data;
    })();
  }
  ...
  getData(id) {
    ...
    return _asyncToGenerator(function* () {
      return yield _this8.where({ id: id, del_flag: 0 }).find();
    })();
  }
};
