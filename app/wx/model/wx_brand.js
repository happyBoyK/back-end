...
module.exports = class extends think.Model {
  ...
  pageData(param) {
    ...
    return _asyncToGenerator(function* () {
      let sql = _this5.page(param.current).where({ del_flag: 0 }).order('create_date desc');
  ...
  changeStatus(param) {
    ...
    return _asyncToGenerator(function* () {
      let id = param.id;
      param.update_date = think.datetime();
      yield _this6.where({ id: id }).update({ is_index: param.is_index, update_date: param.update_date });
    })();
  }
