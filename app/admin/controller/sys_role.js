...
module.exports = class extends Base {
  ...
  allDataAction() {
    ...
    return _asyncToGenerator(function* () {
      let data = yield _this2.model("sys_role").allData();
  ...
  pageDataAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      let data = yield _this3.model("sys_role").pageData(param);
  ...
  addDataAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this4.model("sys_role").addData(param);
  ...
  updateDataAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this5.model("sys_role").updateData(param);
  ...
  delDataAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this6.model("sys_role").delData(param);
